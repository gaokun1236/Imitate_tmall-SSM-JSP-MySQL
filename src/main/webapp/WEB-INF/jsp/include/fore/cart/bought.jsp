...
<div class="boughtDiv">
    <div class="orderType">
        <div class="selectedOrderType"><a orderSatus="all" href="#nowhere">所有订单</a></div>
...
<c:forEach items="${o.orderItems}" var="oi" varStatus="st">
    <tr class="orderItemProductInfoPartTR">
        <td class="orderItemProductInfoPartTD"><img width="80" height="80" src="img/prductSingle_middle/${oi.product.firstProductImage.id}.jpg">
        </td>
        <td class="orderItemProductInfoPartTD">
            <div class="orderListItemProductLinkOutDiv">
                ...
                <div class="orderListItemProductLinkInnerDiv">
                    ...
                    <img src="img/site/7day.png" title="消费者保障服务，承诺7天无理由退货哦">
