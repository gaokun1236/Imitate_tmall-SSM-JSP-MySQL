...
$("button.createOrderButton").click(function () {
    ...
    function calcCartSumPriceAndNumber() {
        var sum=0;
        var totalNumber=0;
        $("img.cartProductItemIfSelected[selected='selectit']".each(function () {
            var oiid=$(this).attr("oiid");
            ...
            var num=$(".orderItemSetting[oiid="+oiid+"]").val();
...
<div class="cartTitle pull-right">
    ...
    <button class="creatOrderButton" disable="disable">结 算</button>
</div>
...
<td>
    ...
    <img class="cartProductImg" src="img/productSingle_middle/${oi.product.firstProductImage.id}.jpg">
                ...
                <td>
                    <div class="cartProductLinkOutDiv">
                        ...
                        <div class="cartProductLinkInnerDiv">
                            ...
                            <img src="img/site/7day.png" title="消费者保障，承诺7天无理由退货">
                ...
                <td>
                    ...
                    <span class="cartProductItemOringalPrice">￥${oi.product.promotePrice}</span>
                </td>
                <td>
...
<div class="cartFoot">
    <img selectit="flase" class="selectAllItem" src="img/site/cartNotSelected.png">
    <span>全选</span>
   <%-- <a href="#">删除</a>--%>

    <div class="pull-right">
        <sapn>已选商品<span class="cartSumNumber">0</span>件</sapn>
        <span>合计（不含运费）：</span>
