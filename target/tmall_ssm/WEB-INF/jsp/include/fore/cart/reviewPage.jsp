...
<div class="reviewDiv">
    <div class="reviewProductInfoDiv">
        <div class="reviewProductInfoImg"><img width="400px" height="400px" src="img/productSingle/${p.firstProductImage.id}.jpg">
        </div>
...
<tr>
    <td width="75px">价格：</td>
    <td><span class="reviewProductInfoTablePrice">￥<fmt:formatNumber type="number" value="${p.originalPrice}"
    minFractionDigits="2"/></span>元</td>
</tr>
                <tr>
                    <td>配送</td>
                    <td>快递：0.00</td>
            ...
            <div class="reviewProductInfoRightBelowDiv">
                ...
                <span class="reviewProductInfoRightBelowText">现在查看的是 您所购买的商品信息于
    ...
    <c:if test="${param.showonly!=true}">
        <div class="makeReviewDiv">
            <from method="post" action="foredoreview">
                <div class="makeReviewText">其他买家需要您的建议哦</div>
